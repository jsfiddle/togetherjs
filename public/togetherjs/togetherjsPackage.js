...
(function (){
var _w_jQuery = window.jQuery;
var _w_$ = window.$;
console.log("glob0", window.jQuery && window.jQuery.fn.jquery);
...
console.log("glob1", window.jQuery && window.jQuery.fn.jquery);
try {
console.log("calling noconflict", jQuery.fn.jquery);
}catch (e){console.log("no jquery")}
jQuery.noConflict(true);
console.log("glob2", window.jQuery && window.jQuery.fn.jquery);
try {
console.log("calling noconflict (after)", jQuery.fn.jquery);
}catch (e){console.log("no jquery2")}
window.jQuery = _w_jQuery;
window.$ = _w_$;
console.log("glob3", window.jQuery && window.jQuery.fn.jquery);
})();
