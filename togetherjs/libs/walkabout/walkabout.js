        ...
        Walkabout.EventAction = Walkabout.Class({
            ...
            run: Walkabout.setInTesting(function run() {
                ...
                if (this.handler && this.handler.runEvent) {
                    ...
                    if (module == "UIEvents") {
                        event.initUIEvent(this.type, props.get("canBubble", true), // canBubble
                        ...
                        event.initMouseEvent(this.type, props.get("canBubble", true), // canBubble
                        props.get("cancelable", true), // cancelable
                        window, // view
                        props.get("detail", 0), // detail
                        ...
                        event.initEvent(this.type, props.get("canBubble", false), // canBubble
                        ...
                        if (event.initKeyEvent) {
                            event.initKeyEvent(this.type, props.get("canBubble", true), // canBubble
                            props.get("cancelable", true), // cancelable
                            window, // window
                            props.get("ctrlKey", false), // ctrlKey
                            props.get("altKey", false), // altKey
        ...
        Walkabout.rewriteListeners = function (code) {
            ...
            var result = falafel(code, function (node) {
                if (node.type == "CallExpression" &&
                    ...
                    node.update("Walkabout." + node.callee.property.name +
                ...
                if (node.type == "MemberExpression" &&
                    ...
                    node.update("Walkabout.value(" + node.object.source() + ")");
                }
            });
        ...
        Walkabout.UI = Walkabout.Class({
            constructor: function UI() {
                this.panel = this.make("div", {
                    ...
                    this.closeButton = this.make("span", {
                        style: this.styles.close
                    }, ["\xd7"]),
                    this.make("div", { style: this.styles.header }, ["Walkabout"]),
                    this.make("div", {}, ["Actions: ",
                        this.actionsField = this.make("span", { style: this.styles.actions }, ["?"]),
                        " Runs: ",
                        this.runField = this.make("span", { style: this.styles.actions }, ["- / -"])
                    ]),
                    this.issues = this.make("div", { style: this.styles.issues }, [
                        this.make("div", { "data-issues-header": 1, style: this.styles.issuesHeader }, ["Issues:"])
                    ]),
                    this.startButton = this.make("button", { style: this.styles.start }, ["start"]),
                    this.onceButton = this.make("button", { style: this.styles.start }, ["run once"]),
                    this.showButton = this.make("button", { style: this.styles.start }, ["show"])
                ]);
