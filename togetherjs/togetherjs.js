...
function conditionalActivate(tjsInstance) {
    ...
    if (callToStart) {
        ...
        callToStart(function () { return onload(tjsInstance); });
    }
    else {
        onload(tjsInstance);
    }
...
export function togetherjsMain() {
    ...
    var tjsInstance = new TogetherJSClass();
    ...
    conditionalActivate(tjsInstance);
