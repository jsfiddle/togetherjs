...
class Change {
    constructor(
        ...
        public delta: TogetherJSNS.TextReplace,
    ...
    clone() {
        ...
        return new Change(this.version, this.clientId, this.delta.clone(), { ...this.known }, this.outOfOrder);
    }
    ...
    knowsAboutChange(change: Change) {
...
class SimpleHistory {
    ...
    public current;
    public basis: number;
    private queue: TogetherJSNS.Change2[] = [];
    private deltaId = 1;
    ...
    getNextToSend(): TogetherJSNS.Change2Mandatory | null {
        ...
        qchange.sent = true;
        return qchange as TogetherJSNS.Change2Mandatory; // TODO is there any way to avoid this cast?
    }
}
