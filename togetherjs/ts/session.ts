...
define(["require", "util", "channels", "jquery", "storage"], function (require: Require, util: Util, channels: ReturnType<typeof ChannelsMain>, $: JQueryStatic, storage: ReturnType<typeof StorageMain>) {
