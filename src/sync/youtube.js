...
// Deferred until the session actually starts. Under RequireJS this module was
// only fetched during session startup; in the bundle it loads with the page,
// and merely including togetherjs.js must not fetch the YouTube iframe API.
