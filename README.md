...
In this project I try to convert TogetherJS to Typescript. At first we will change the logic as little as possible to have a drop in replacement for the old Together**JS**.
