...
module.exports = function(grunt) {
    ...
    grunt.registerTask("publish", "Publish to togetherjs.mozillalabs.com/public/", function() {
        ...
        if(!grunt.option("base-url")) {
            grunt.option("base-url", "https://ks3371053.kimsufi.com:7071");
        }
    ...
    grunt.registerMultiTask("phantom-tests", function() {
        ...
        var url = grunt.option('base-url') + "togetherjs/tests/index.html?name=" + this.target;
        ...
        phantomjs.spawn(url, {
            options: options,
                ...
                if(phantomStatus.failed > 0) {
                    grunt.warn(phantomStatus.failed + '/' + phantomStatus.total + ' assertions failed (' + duration + 'ms)');
                }
